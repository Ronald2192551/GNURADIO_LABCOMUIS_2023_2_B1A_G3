...
class Modulador_de_amplitud_basado_en_GNURadio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulador_de_amplitud_basado_en_GNURadio")
        ...
        # Connections
        ##################################################
        self.connect((self.ModuladorAMV2_0, 0), (self.blocks_complex_to_real_0, 0))
...
def main(top_block_cls=Modulador_de_amplitud_basado_en_GNURadio, options=None):
