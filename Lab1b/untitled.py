...
# Title: Lab_1_Parte_2
# Author: Ronald_Paez_Leidy_Escobar_B1A_G3
...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab_1_Parte_2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab_1_Parte_2")
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(1000, 80000, 1000, 80000, 200)
