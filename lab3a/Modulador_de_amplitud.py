...
from CalculoPotenciaComunicacionesL1C_MILLER_CELIS import CalculoPotenciaComunicacionesL1C_MILLER_CELIS  # grc-generated hier_block
...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.calculo_potencia_ronald = CalculoPotenciaComunicacionesL1C_MILLER_CELIS(
            I_vect=1024,
        )

        self.top_layout.addWidget(self.calculo_potencia_ronald)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.calculo_potencia_ronald, 0))
