...
class Punto_5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "audio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Punto_5")
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(1000, 300000, 1000, 44000, 200)
        self._samp_rate_win = RangeWidget(self._samp_rate_range, self.set_samp_rate, 'ffrecuencia de muestreo', "counter_slider", int)
