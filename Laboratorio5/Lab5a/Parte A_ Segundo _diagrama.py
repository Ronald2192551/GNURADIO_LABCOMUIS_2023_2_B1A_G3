...
class Parte A_ Segundo _diagrama(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Parte A_ Segundo _diagrama")
        ...
        self.connect((self.ModulacionPAM_2, 0), (self.blocks_delay_1, 0))
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.ModulacionPAM_2, 0))
        self.connect((self.analog_sig_source_x_3, 0), (self.ModulacionPAM_3, 0))
...
def main(top_block_cls=Parte A_ Segundo _diagrama, options=None):
