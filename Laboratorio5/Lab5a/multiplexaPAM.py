...
class multiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, "freciencia mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_4 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, fm, Am, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.ModulacionPAM_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.ModulacionPAM_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModulacionPAM_1, 0), (self.blocks_delay_0, 0))
        self.connect((self.ModulacionPAM_2, 0), (self.blocks_delay_2, 0))
        self.connect((self.ModulacionPAM_3, 0), (self.blocks_delay_1, 0))
        self.connect((self.ModulacionPAM_4, 0), (self.blocks_delay_3, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModulacionPAM_0, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.ModulacionPAM_1, 0))
        self.connect((self.analog_sig_source_x_2, 0), (self.ModulacionPAM_3, 0))
        self.connect((self.analog_sig_source_x_3, 0), (self.ModulacionPAM_2, 0))
        self.connect((self.analog_sig_source_x_4, 0), (self.ModulacionPAM_4, 0))
        ...
        self.connect((self.blocks_delay_3, 0), (self.blocks_add_xx_0, 4))
        self.connect((self.blocks_delay_3, 0), (self.qtgui_time_sink_x_0, 5))
    ...
    def set_fm(self, fm):
        ...
        self.analog_sig_source_x_4.set_frequency(self.fm)
    ...
    def set_D(self, D):
        ...
        self.ModulacionPAM_4.set_D(self.D)
    ...
    def set_Am(self, Am):
        ...
        self.analog_sig_source_x_4.set_amplitude(self.Am)
